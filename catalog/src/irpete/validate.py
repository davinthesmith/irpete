...
**Mark-first normalization:** IRremoteESP8266 `sendRaw` expects the
...
# ESP8266 RAM / JSON size guard (aligned with envelope limits).
MAX_RAW_ELEMENTS = 512
MIN_RAW_ELEMENTS = 2
# Per pulse in microseconds (fits uint16 on Emitter).
MIN_PULSE_US = 1
MAX_PULSE_US = 65535
